            ...
            <nav class="main_nav_container">
                <div class="main_nav">
                    <ul class="main_nav_list">
                        ...
                        <li class="main_nav_item"><a href="{{asset('courses')}}">courses</a></li>
                        <li class="main_nav_item"><a href="{{asset('elements')}}">elements</a></li>
                        <li class="main_nav_item"><a href="{{asset('news')}}">news</a></li>
                        <li class="main_nav_item"><a href="{{asset('contact')}}">contact</a></li>
                    </ul>
                </div>
            </nav>
        </div>
