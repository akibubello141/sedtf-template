					...
					<div class="news_posts">
						...
						<div class="news_post">
							<div class="news_post_image">
								<img src="{{asset('images/news_1.jpg')}}" alt="https://unsplash.com/@dsmacinnes">
							</div>
						...
						<div class="news_post">
							<div class="news_post_image">
								<img src="{{asset('images/news_2.jpg')}}" alt="https://unsplash.com/@dsmacinnes">
							</div>
							<div class="news_post_top d-flex flex-column flex-sm-row">
								<div class="news_post_date_container">
									<div class="news_post_date d-flex flex-column align-items-center justify-content-center">
						...
						<div class="news_post">
							<div class="news_post_image">
								<img src="{{asset('images/news_3.jpg')}}" alt="https://unsplash.com/@dsmacinnes">
							</div>
							<div class="news_post_top d-flex flex-column flex-sm-row">
								<div class="news_post_date_container">
									<div class="news_post_date d-flex flex-column align-items-center justify-content-center">
							...
							<div class="latest_posts">
								...
								<div class="latest_post">
									<div class="latest_post_image">
										<img src="{{asset('images/latest_1.jpg')}}" alt="https://unsplash.com/@dsmacinnes">
									</div>
